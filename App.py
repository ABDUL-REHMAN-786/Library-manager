...
# ✅ **Statistics**
    ...
    st.markdown(f"""
    <h4>Total Books: {total_books}</h4>
    <h4>Books Read: {read_books}</h4>
    <h4>Books Unread: {unread_books}</h4>
    <h4>Most Common Genre: {most_common_genre}</h4>
    <h4>Most Read Author: {most_read_author}</h4>
    """, unsafe_allow_html=True)

# ✅ **Import/Export Books**
elif menu == "📥 Import/Export":
    st.subheader("📥 Import/Export Books")
